...
<body>
	...
	<div class="col-md-9">
    <h1 class="text-center my-5">Artist</h1>
           ...
           if(mysqli_num_rows($result) > 0) {
               ...
               { ?>
			        <div class="col-md-3 album-cover-art text-center" style="padding: 10px 10px;">
                        <a href="viewartistsong.php?id=<?php echo $row['ARTIST_ID'];?>"><img width="80%"  src="artistimage/<?php echo $row['ARTIST_IMAGE']; ?>" alt="No Cover Image" style=""/></a>
